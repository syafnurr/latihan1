...
@if($icon == 'sun')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
@elseif($icon == 'upload-cloud')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
@elseif($icon == 'arrow-long-up')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 6.75L12 3m0 0l3.75 3.75M12 3v18" />
    </svg>
@elseif($icon == 'arrow-long-down')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 17.25L12 21m0 0l-3.75-3.75M12 21V3" />
    </svg>
@elseif($icon == 'arrow-small-up')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 19.5v-15m0 0l-6.75 6.75M12 4.5l6.75 6.75" />
    </svg>
@elseif($icon == 'arrow-small-down')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75" />
    </svg>
@elseif($icon == 'arrow-chart-up')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 14" stroke-width="1.5" stroke="currentColor">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13V1m0 0L1 5m4-4 4 4"/>
    </svg>
@elseif($icon == 'arrow-chart-down')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 14" stroke-width="1.5" stroke="currentColor">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 1V13m0 0L1 9m4 4 4-4"/>
    </svg>
@elseif($icon == 'link')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
@elseif ($icon == 'coins')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round"
            d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />
    </svg>
@elseif($icon == 'user')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
...
@elseif($icon == 'bars-3')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} mlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
@elseif($icon == 'sortable')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
@elseif($icon == 'loyalty')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
...
@elseif($icon == 'plus')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
@elseif($icon == 'info')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20"
    fill="currentColor" aria-hidden="true">
        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
    </svg>
@elseif($icon == 'arrow-right-on-rectangle')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9" />
    </svg>
@elseif($icon == 'arrow-top-right-on-square')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
@elseif($icon == 'carrot')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
    @elseif($icon == 'trash')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
@elseif($icon == 'close')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
    clip-rule="evenodd"></path>
    </svg>
@elseif($icon == 'arrow-left-on-rectangle')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
@elseif($icon == 'presentation-chart-line')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5m.75-9l3-3 2.148 2.148A12.061 12.061 0 0116.5 7.605" />
    </svg>
@elseif($icon == 'scan-qr')
    <svg class="{{ $class }}" {{ $attributes ?? '' }} fill="currentColor" viewBox="0 0 371.643 371.643" stroke="currentColor"
    ...
    <g>
        ...
        <g>
            <path
                d="M311.596,190.189c-7.441-9.347-18.403-16.206-32.743-20.522V30c0-16.542-13.458-30-30-30H125.084
    ...
    c5.514,0,10,4.486,10,10v135.579c-3.032-0.381-6.15-0.694-9.389-0.914C224.305,162.971,207.094,172.413,204.566,189.331z" />
            <path
                d="M179.129,83.167h-24.06c-2.761,0-5,2.238-5,5v24.061c0,2.762,2.239,5,5,5h24.06c2.761,0,5-2.238,5-5V88.167
    C184.129,85.405,181.89,83.167,179.129,83.167z" />
            <path
                d="M172.629,142.86h-12.56V130.8c0-2.762-2.239-5-5-5c-2.761,0-5,2.238-5,5v17.061c0,2.762,2.239,5,5,5h17.56
    c2.761,0,5-2.238,5-5C177.629,145.099,175.39,142.86,172.629,142.86z" />
            <path
                d="M216.568,83.167h-24.06c-2.761,0-5,2.238-5,5v24.061c0,2.762,2.239,5,5,5h24.06c2.761,0,5-2.238,5-5V88.167
    C221.568,85.405,219.33,83.167,216.568,83.167z M211.568,107.228h-14.06V93.167h14.06V107.228z" />
            <path
                d="M211.669,125.936H197.41c-2.761,0-5,2.238-5,5v14.257c0,2.762,2.239,5,5,5h14.259c2.761,0,5-2.238,5-5v-14.257
