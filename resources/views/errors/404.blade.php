...
<section class="mx-auto">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
            ...
            <p class="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl dark:text-white">{{ trans('common.404_title') }}</p>
            <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">{!! trans('common.404_description') !!}</p>
