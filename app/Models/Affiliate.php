...
use App\QueryBuilders\AffiliateQueryBuilder;
 ...
 * Class Affiliate
 *
 * Represents an Affiliate in the application.
 */
class Affiliate extends Authenticatable implements HasLocalePreference, HasMedia
{
     ...
     *
     * @param  mixed  $query
     * @return AffiliateQueryBuilder
     */
    public function newEloquentBuilder($query)
    {
        return new AffiliateQueryBuilder($query);
    }
    ...
    /**
     * Get the network associated with the affiliate.
     *
